...
# data <-select(data_raw, awarding_agency_name, total_obligated_amount, recipient_state_name, recipient_county_name, prime_award_summary_recipient_state_fips_code) # limit to relevant fields
...
#join REEO data to shapefile
colnames(funData_national)[2] <- "STATE"
funData_national <- left_join(territories, funData_national, by = "STATE")
# st_write(funData_national, "C:/Users/GraceParker/Downloads/2023_FederalFundingTracker/RegMap.shp") #export to ArcGIS where I dissolved state boundaries
RegMap <- st_read("C:/Users/GraceParker/Downloads/2023_FederalFundingTracker/RegMapDissolved/", quiet=TRUE) #read in dissolved layer
...
pie <- ggplot(funcSC, aes(x="", y=Percent, fill=Category))+
  geom_bar(width = 1, stat = "identity")+
  coord_polar("y", start=0)+
  scale_fill_manual(values=c("#FFA07A","#F08080", "#900C3F", "#C70039", "#D4442D","#FFF7B3","#00869F", "#154360","#6171AF","#DCB6D0","#C799C8", "#D2D2D2", "#7B7B7B","#585757")) +
