...
###SET WORKING DIRECTORY TO GitHubFolder in 2023_FederalFundingTracker
...
#insert shapefile for states and territories
territories <- st_read("../Territories", quiet=TRUE)

#these targets are the FIPS codes needed to filter data to relevant states and territories
...
Asst2024_raw <- read.csv("../Data_01_22_2024/BILFY2~3/FY2024~3.csv")
Con2024_raw <- read.csv("../Data_01_22_2024/BILFY2~3/FY2024~2.CSV")
Unl2024_raw <- read.csv("../Data_01_22_2024/BILFY2~3/FY2024~4.CSV")

Asst2023_raw <- read.csv("../Data_01_22_2024/BILFY2~2/FY2023~3.CSV")
Con2023_raw <- read.csv("../Data_01_22_2024/BILFY2~2/FY2023~2.CSV")
Unl2023_raw <- read.csv("../Data_01_22_2024/BILFY2~2/FY2023~4.CSV")

Asst2022_raw <- read.csv("../Data_01_22_2024/BILFY2~1/FY2022~3.CSV")
Con2022_raw <- read.csv("../Data_01_22_2024/BILFY2~1/FY2022~2.CSV")
Unl2022_raw <- read.csv("../Data_01_22_2024/BILFY2~1/FY2022~4.CSV")

#insert population data
pop2022_raw <- read.csv("../POP2022.csv")

#bind funding data together--may need to add more as additional years are in the data
...
#group national funding by territory/state
...
#group SE funding by territory/state
...
#divide national funding total by total population 
...
#create table of regional funding
Regiontable%>% kbl(row.names=FALSE) %>%
  ...
  column_spec(2, "3cm")
Regiontable
# save_kable(Regiontable,"C:/Users/GraceParker/Downloads/2023_FederalFundingTracker/Regiontable.png") #this is for saving a table for the report

# ###whitepaper maps
#national map at region level for grant and total funding
# regions <- st_read("../AlbersShapefile/albers_us1_Dissolve.shp")
# #join by FIPS or iso
...
# tm_layout(main.title = "The Northeast Has Received Far More Grant Funding Than Any Other Region",
...
#       legend.bg.alpha=.6)
# tmap_save(filename="../Grants_Nat_02_2024v2.png", height=4, width =6, dpi=1200)
# 
...
#retrieve total and perCap for US for the report
...
#calculate percent and per cap funding for the report
...
##create interactive map with total and grant funding, this is main map on dashboard
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='hide', fig.show='hide'}
##whitepaper maps, southeast total funding
# tmap_mode(mode ="plot")
...
#       legend.title.size= 1)
# 
# tmap_save(filename="../SE_total_02_2024.png", height=4, width =6, dpi=1200)

```

```{r, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='hide', fig.show='hide'}
##whitepaper maps, southeast grant funding
#tmap
# tmap_mode(mode ="plot")
# bbox_SE <- st_bbox(SEstates)
# 
...
#       legend.title.size= 1)
# # 
# tmap_save(filename="../Grants_SE_02_2024.png", height=4, width =6, dpi=1200)

#this create a region table and saves it, we ended up just copying it into excel for formatting
...
#calculate Southeast percent of funding for whitepaper
...
#calculate direct spending for whitepaper
...
<div class = "col-md-5">
``` {r echo=FALSE}
##create table of funding in teh southeast for whitepaper
# SEdata <- SEdata[order(SEdata$Funding,decreasing=TRUE),]
...
##this explores deobligated funding for whitepaper
